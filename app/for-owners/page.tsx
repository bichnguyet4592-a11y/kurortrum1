    ...
    return (
      <main style={{ fontFamily: 'sans-serif', background: '#f9fafb', minHeight: '100vh' }}>
        ...
        <section style={{ background: '#065f46', color: 'white', padding: '60px 24px', textAlign: 'center' }}>
          <h1 style={{ fontSize: '28px', fontWeight: 600, marginBottom: '12px' }}>Разместите жильё на КМВ</h1>
          <p style={{ color: '#6ee7b7', fontSize: '16px', marginBottom: '8px' }}>Прямые заявки от туристов · Без комиссии с бронирования</p>
          <p style={{ color: '#6ee7b7', fontSize: '14px' }}>7 дней бесплатно — начните прямо сейчас</p>
        </section>
        ...
        <section style={{ maxWidth: '900px', margin: '0 auto', padding: '48px 24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }}>
            ...
            {/* Про */}
            <div style={{ background: 'white', border: '2px solid #059669', borderRadius: '16px', padding: '28px', position: 'relative' }}>
        ...
        <section style={{ background: 'white', padding: '48px 24px' }}>
          <div style={{ maxWidth: '700px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              {[
                { n: '1', title: 'Зарегистрируйтесь', text: 'Создайте аккаунт за 2 минуты — 7 дней бесплатно' },
