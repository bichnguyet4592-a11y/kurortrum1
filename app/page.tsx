      ...
      <nav className="nav-transparent">
        <a href="/" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.15 }}>
            <span style={{ fontSize: '22px', fontWeight: 800, color: 'white', letterSpacing: '-0.03em' }}>
              Курорт<span style={{ color: '#2BAE8E' }}>рум</span>
            </span>
            <span style={{ fontSize: '11px', color: 'rgba(255,255,255,0.55)', letterSpacing: '0.08em' }}>жильё на КМВ</span>
          </div>
        </a>
