  ...
  return (
    <main style={{ fontFamily: 'sans-serif', background: '#f9fafb', minHeight: '100vh' }}>
      ...
      <nav style={{ background: 'white', borderBottom: '1px solid #e5e7eb', padding: '16px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <a href="/catalog" style={{ fontSize: '14px', color: '#6b7280', textDecoration: 'none' }}>← Каталог</a>
      </nav>
      ...
      <div className="property-pad" style={{ maxWidth: '1000px', margin: '0 auto', padding: '32px 24px' }}>
        <div className="property-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: '32px' }}>
          <div>
            <div className="photo-box" style={{ height: '320px', background: '#d1fae5', borderRadius: '16px', overflow: 'hidden', marginBottom: '24px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '64px' }}>
